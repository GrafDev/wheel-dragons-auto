...
export class Game1 {
    ...
    updateCounterText() {
        if (this.counterTextElement) {
            const remainingSpins = 1 - gameState.spinCount;
    ...
    spin() {
        ...
        // Останавливаем медленное вращение колеса
        gsap.killTweensOf([this.wheelElement, document.querySelector('.wheel-text-image')]);
