...
export class Animations1 {
    ...
    static initializePageElements() {
        ...
        const logo02 = document.querySelector('.logo02:not(.dragons)');
        if (logo02) {
            gsap.from(logo02, {
                scale: 0,
                opacity: 0,
        ...
        const logo02Dragons = document.querySelector('.logo02.dragons');
        if (logo02Dragons) {
            gsap.from(logo02Dragons, {
                scale: 5,
                opacity: 0,
                duration: 1.2,
                delay: 0.4,
